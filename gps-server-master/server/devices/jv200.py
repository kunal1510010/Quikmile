...
class JV200Protocol(BaseGPSProtocol):
    PORT = 5007
    ...
    async def start(self):
        ...
        while True:
            ...
            try:
                ...
                logger.info("JV200 Server -> terminal:\n{}".format(self._packet.response))
                logger.warning(self._packet.content)
                logger.warning(self._packet.protocol)
                logger.warning(self.hex_to_list(hexlify))
